%% This is the testing demo of FFDNet for denoising real noisy (gray-level) images.
...
for i = 3
    ...
    if showResult
        ...
        %imwrite(im2uint8(output), fullfile(folderResultCur, [nameCur, '_' num2str(inputNoiseSigma,'%02d'), extCur] ));
        drawnow;
        pause(pauseTime)
    end
